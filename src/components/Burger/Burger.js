...
const burger = ( props ) => {
    ...
    // line 10- [ , ] (with "salad" as igKey) gets mapped with an index, so the key is "salad0" and type is "salad" on first time through map, then "salad1" key with "salad" type for another BurgerIngredient component
